    ...
    <div className="font-sans bg-gray-50">
      ...
      <footer className="bg-gray-800 text-white py-8 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">About SGT</h3>
            <p className="text-gray-400 text-sm">
              SGT University is a leading educational institution committed to excellence in teaching, research, and innovation.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <address className="text-sm text-gray-400 not-italic">
              Budhera, Gurugram-Badli Road<br />
              Gurugram, Haryana 122505<br />
              Phone: +91 124 2278183<br />
